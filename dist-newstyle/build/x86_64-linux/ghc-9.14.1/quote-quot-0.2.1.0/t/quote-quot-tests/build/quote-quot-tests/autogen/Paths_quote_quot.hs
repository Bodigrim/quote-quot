...
-- at runtime using the environment variable quote_quot_bindir.
...
-- environment variable quote_quot_libdir.
...
-- using the environment variable quote_quot_dynlibdir.
...
-- runtime using the environment variable quote_quot_datadir.
...
-- using the environment variable quote_quot_sysconfdir.
...
libdir     = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.14.1-c6c3/quote-quot-0.2.1.0-inplace-quote-quot-tests"
dynlibdir  = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.14.1-c6c3"
datadir    = "/home/runner/.cabal/share/x86_64-linux-ghc-9.14.1-c6c3/quote-quot-0.2.1.0"
libexecdir = "/home/runner/.cabal/libexec/x86_64-linux-ghc-9.14.1-c6c3/quote-quot-0.2.1.0"
sysconfdir = "/home/runner/.cabal/etc"

getBinDir     = catchIO (getEnv "quote_quot_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "quote_quot_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "quote_quot_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "quote_quot_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "quote_quot_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "quote_quot_sysconfdir") (\_ -> return sysconfdir)
